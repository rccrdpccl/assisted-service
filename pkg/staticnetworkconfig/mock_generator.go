...
//
//	mockgen -source=generator.go -package=staticnetworkconfig -destination=mock_generator.go
//
...
func (mr *MockStaticNetworkConfigMockRecorder) FormatStaticNetworkConfigForDB(staticNetworkConfig any) *gomock.Call {
...
func (mr *MockStaticNetworkConfigMockRecorder) GenerateStaticNetworkConfigData(ctx, hostsYAMLS any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaticNetworkConfigMockRecorder) GenerateStaticNetworkConfigDataYAML(staticNetworkConfigStr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaticNetworkConfigMockRecorder) NMStatectlServiceSupported(version, arch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaticNetworkConfigMockRecorder) ValidateStaticConfigParamsYAML(staticNetworkConfig, ocpVersion, arch, installerInvoker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
