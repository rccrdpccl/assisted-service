...
func (m *MockInstallConfigGenerator) GenerateInstallConfig(ctx context.Context, cluster common.Cluster, cfg []byte, releaseImage, installerReleaseImageOverride string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateInstallConfig", ctx, cluster, cfg, releaseImage, installerReleaseImageOverride)
	ret0, _ := ret[0].(error)
	return ret0
}

// GenerateInstallConfig indicates an expected call of GenerateInstallConfig.
func (mr *MockInstallConfigGeneratorMockRecorder) GenerateInstallConfig(ctx, cluster, cfg, releaseImage, installerReleaseImageOverride any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateInstallConfig", reflect.TypeOf((*MockInstallConfigGenerator)(nil).GenerateInstallConfig), ctx, cluster, cfg, releaseImage, installerReleaseImageOverride)
}
