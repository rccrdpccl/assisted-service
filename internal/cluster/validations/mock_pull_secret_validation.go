...
//
//	mockgen -source=pull_secret_validation.go -package=validations -destination=mock_pull_secret_validation.go
//
...
func (mr *MockPullSecretValidatorMockRecorder) ValidatePullSecret(secret, username, releaseImageURL any) *gomock.Call {
