...
//
//	mockgen -source=metricsManager.go -package=metrics -destination=mock_metrics_manager_api.go
//
...
func (mr *MockAPIMockRecorder) ClusterInstallationFinished(ctx, result, prevState, clusterVersion, clusterID, emailDomain, installationStartedTime any) *gomock.Call {
...
func (mr *MockAPIMockRecorder) ClusterValidationChanged(clusterValidationType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) ClusterValidationFailed(clusterValidationType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) DiskSyncDuration(syncDuration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) Duration(operation, duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) FileSystemUsage(usageInPercentage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) HostValidationChanged(hostValidationType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) HostValidationFailed(hostValidationType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) ImagePullStatus(imageName, resultStatus, downloadRate any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) MonitoredClusterCount(monitoredClusters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) MonitoredHostsCount(monitoredHosts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) ReportHostInstallationMetrics(ctx, clusterVersion, clusterID, emailDomain, boot, h, previousProgress, currentStage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
