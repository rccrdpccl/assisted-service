...
//
//	mockgen --build_flags=--mod=mod -package=api -self_package=github.com/openshift/assisted-service/internal/operators/api -destination=mock_operator_api.go . Operator
//
...
func (mr *MockOperatorMockRecorder) GenerateManifests(arg0 any) *gomock.Call {
...
func (mr *MockOperatorMockRecorder) GetDependencies(cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDependencies", reflect.TypeOf((*MockOperator)(nil).GetDependencies), cluster)
}
...
func (m *MockOperator) GetHostRequirements(ctx context.Context, cluster *common.Cluster, host *models.Host) (*models.ClusterHostRequirementsDetails, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetHostRequirements", ctx, cluster, host)
...
func (mr *MockOperatorMockRecorder) GetHostRequirements(ctx, cluster, host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHostRequirements", reflect.TypeOf((*MockOperator)(nil).GetHostRequirements), ctx, cluster, host)
}
...
func (mr *MockOperatorMockRecorder) GetPreflightRequirements(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPreflightRequirements", reflect.TypeOf((*MockOperator)(nil).GetPreflightRequirements), ctx, cluster)
}
...
func (m *MockOperator) ValidateCluster(ctx context.Context, cluster *common.Cluster) (ValidationResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOperatorMockRecorder) ValidateCluster(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateCluster", reflect.TypeOf((*MockOperator)(nil).ValidateCluster), ctx, cluster)
}

// ValidateHost mocks base method.
func (m *MockOperator) ValidateHost(ctx context.Context, cluster *common.Cluster, hosts *models.Host, additionalOperatorRequirements *models.ClusterHostRequirementsDetails) (ValidationResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateHost", ctx, cluster, hosts, additionalOperatorRequirements)
	ret0, _ := ret[0].(ValidationResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockOperatorMockRecorder) ValidateHost(ctx, cluster, hosts, additionalOperatorRequirements any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateHost", reflect.TypeOf((*MockOperator)(nil).ValidateHost), ctx, cluster, hosts, additionalOperatorRequirements)
}
